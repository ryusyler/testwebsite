...
// General Settings
	...
	$wp_customize->add_control( 'slider_show', array(
		'label'        => __( 'Show slider on homepage', 'healthcare' ),
		'type'=>'checkbox',
		'section'    => 'healthcare_slider_images',
		'settings'   => 'health_options[slider_show]',
	) );
	...
	$wp_customize->add_setting(	'health_options[callout_enable]',array(
			'type'    => 'option',
			'default'=>$health_data['callout_enable'],
			'sanitize_callback'=>'health_care_sanitize_text',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control( 'health_callout_enable', array(
		'label'        => __( 'Show Callout Section on front-page', 'healthcare' ),
		'type'=>'checkbox',
		'section'    => 'general_section',
		'settings'   => 'health_options[callout_enable]',
	) );	
...
//Social Settings
	...
	$wp_customize->add_setting('health_options[footer_widget]',array(
		'type'    => 'option',
		'default'=>$health_data['footer_widget'],
		'sanitize_callback'=>'health_care_sanitize_text',
		'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control( 'health_footer_widget', array(
		'label'        => __( 'Footer Widgets','healthcare' ),
		'type'=>'checkbox',
		'section'    => 'social_sction',
		'settings'   => 'health_options[footer_widget]',
	) );
