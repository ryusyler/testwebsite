...
function  gpp_alt_styles() {
    ...
    if ( isset ( $theme_options['color'] ) && '' != $theme_options['color'] ) {
        $file1 = get_stylesheet_directory() . '/css/' . $theme_options['color'] . '.css';
        $file2 = get_template_directory() . '/css/' . $theme_options['color'] . '.css';
                ...
                <script type="text/javascript">
                    jQuery(document).ready(function(){
                        ...
                        jQuery(".sortable-options .tab_section").each(function(){
                            jQuery(this).parent().nextUntil("h2").addBack()
                        ...
                        jQuery("#wpbody-content").on("click", ".sortable-block h2", function(){
